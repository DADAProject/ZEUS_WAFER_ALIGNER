...
namespace System.Windows.Forms
{
	...
	public class Grouper : GroupBox
	{
		...
		private void PaintGroupText(System.Drawing.Graphics g)
		{
			...
			int ArcX1 = ArcWidth + 5;
			int ArcX2 = (this.GroupImage != null) ? (this.Font.Bold ? (StringSize2.Width + 24) - (ArcWidth + 1) : (StringSize2.Width + 21) - (ArcWidth + 1)) + ArcWidth :
													(this.Font.Bold ? (StringSize2.Width + 19) - (ArcWidth + 1) : (StringSize2.Width + 16) - (ArcWidth + 1)) + ArcWidth;
			int ArcY1 = 0;
			int ArcY2 = (StringSize2.Height + 12) - (ArcHeight + 1); // 24
			...
			//Paint Text-------------------------
			int CustomStringWidth = (this.GroupImage != null) ? 36 : 10;
			CustomStringWidth += this.RoundCorners;
			...
			if (this.GroupImage != null)
			{
				...
				g.DrawImage(this.GroupImage, 20, 5, StringSize2.Height, StringSize2.Height);
			}
			//-----------------------------------
