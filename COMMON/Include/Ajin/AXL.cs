...
public class CAXL
{
    static CAXL()
    {
        if (Environment.Is64BitProcess)
            File.Copy(Application.StartupPath + "\\x64\\AXL.dll", Application.StartupPath + "\\AXL.dll", true);
        else
            File.Copy(Application.StartupPath + "\\x86\\AXL.dll", Application.StartupPath + "\\AXL.dll", true);
    }
