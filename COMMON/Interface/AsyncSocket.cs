...
namespace eMachine
{
    ...
    /***************************************************************************/
    /* Class: AsyncSocketErrorEventArgs : EventArgs                            */
    /* Create:                                                                 */
    /* Developer:                                                              */
    /* Note:                                                                   */
    /***************************************************************************/
    ...
    /***************************************************************************/
    /* Class: AsyncSocketConnectionEventArgs : EventArgs                       */
    /* Create:                                                                 */
    /* Developer:                                                              */
    /* Note:                                                                   */
    /***************************************************************************/
    ...
    /***************************************************************************/
    /* Class: AsyncSocketSendEventArgs : EventArgs                             */
    /* Create:                                                                 */
    /* Developer:                                                              */
    /* Note:                                                                   */
    /***************************************************************************/
    ...
    /***************************************************************************/
    /* Class: AsyncSocketReceiveEventArgs : EventArgs                          */
    /* Create:                                                                 */
    /* Developer:                                                              */
    /* Note:                                                                   */
    /***************************************************************************/
    ...
    /***************************************************************************/
    /* Class: AsyncSocketAcceptEventArgs : EventArgs                           */
    /* Create:                                                                 */
    /* Developer:                                                              */
    /* Note:                                                                   */
    /***************************************************************************/
    ...
    {        
        ...
        public bool Connect(string hostAddress, int port)
        {
            ...
            if(hostAddress == "") hostAddress = "192.0.0.1";
            if(port        <= 0 ) port        = 8000;
        ...
        public bool Send(byte[] buffer, int iLength)
        {
            try
            {
                if (conn == null) return false;
                ...
                client.BeginSend(buffer, 0, iLength, 0, new AsyncCallback(OnSendCallBack), client);
            }
            catch (System.Exception e)
            {
                AsyncSocketErrorEventArgs eev = new AsyncSocketErrorEventArgs(this.id, e);
        ...
        public void Stop(){
            try{
                if(listener != null){
					...
					if (listener.IsBound) listener.Close(100);                        
                }                
            }
            catch (System.Exception e){
                AsyncSocketErrorEventArgs eev = new AsyncSocketErrorEventArgs(this.id, e);
    ...
    public class AsyncSocketServer
    {
        ...
        public AsyncSocketServer(int Port, string sHostIP = "")
        {
            try
            {
                ...
                //string strIP = host.AddressList[0].ToString();

                sHostIP = "";
                if (sHostIP == "") { 
                    server.Bind(new IPEndPoint(IPAddress.Any, iPort));
                    }
                else { 
                    IPAddress hostIP = IPAddress.Parse(sHostIP);
            ...
            {
               cDEF.LOG.ExceptionTrace("Socket AsyncSocketServer" + exc.ToString());
            }
        }
        ~AsyncSocketServer()
        {
        ...
        public void Reset()
        {
            ...
            {
               cDEF.LOG.ExceptionTrace("AsyncSocketServer. Reset() " + exc.ToString());
            }
        }
        ...
        public void ServerProc()
        {
            ...
            try
            {
                while (true)
                {
                    ...
                    {
                        if (!client.Connected)  Connected = false;     // If the client is disconnected
            ...
            {
                Connected = false;
                cDEF.LOG.ExceptionTrace("AsyncSocketServer. ServerProc() " + exc.ToString());
            }
        }
        ...
        public void Send(byte[] data)
        {
            ...
            {
                Connected = false;
                cDEF.LOG.ExceptionTrace("AsyncSocketServer.Send() " + exc.ToString());
            }
        }
