...
namespace eMachine
{
    public static class BitmapHelper
    {
        ...
        public static Bitmap CreateGrayscaleImage(int width, int height, IntPtr ptr)
        {
            // create new image
            Bitmap image = new Bitmap(width, height, width, PixelFormat.Format8bppIndexed, ptr);
        ...
        /// <summary>
        /// Create and initialize new 24 bpp Color image.
        /// </summary>
        /// 
        /// <param name="width">Image width.</param>
        /// <param name="height">Image height.</param>
        ...
        /// <returns>Returns the created grayscale image.</returns>
        /// 
        /// <remarks>The method creates new 24 bpp Color image and initializes 
        /// Grayscale image is represented as
        /// <see cref="System.Drawing.Imaging.PixelFormat">Format24bppRgb</see>
        /// 
        public static Bitmap CreateColorImage(int width, int height)
        {
            // create new image
        ...
        public static void ConvertColor8bppToGrayscale8bpp(this Bitmap bitmap)
        {
            ...
            BitmapData sourceData = bitmap.LockBits(rect, ImageLockMode.ReadWrite, bitmap.PixelFormat);
        ...
        public unsafe static Bitmap MakeGrayscale(this Bitmap original)
        {
            ...
            newBitmap.SetGrayscalePalette();
            newBitmap.UnlockBits(newData);

            return newBitmap;
        }

        public static byte[] GetPtr(this Bitmap bitmap, PixelFormat pixelFormat)
        {
            //if (bitmap.PixelFormat != PixelFormat.Format8bppIndexed)
            //    throw new UnsupportedImageFormatException("Only 8-bpp images are supported.");
            ...
            Marshal.Copy(ptr, rgbvalues, 0, stride * height);
        ...
        private static Bitmap Copy(this BitmapData sourceData, Bitmap destination)
        {
            ...
            BitmapData destinationData = destination.LockBits(rect, ImageLockMode.WriteOnly, destination.PixelFormat);
        ...
        public static Bitmap Convert16bppTo8bpp(this Bitmap source, Bitmap destination)
        {
            ...
            Rectangle rect = new Rectangle(0, 0, source.Width, source.Height);
            BitmapData sourceData = source.LockBits(rect, ImageLockMode.ReadOnly, source.PixelFormat);
            BitmapData newData = destination.LockBits(rect, ImageLockMode.ReadWrite, source.PixelFormat);
        ...
        public static Bitmap Convert8bppTo16bpp(this Bitmap bitmap)
        {
            ...
            BitmapData newData = newImage.LockBits(rect, ImageLockMode.ReadWrite, bitmap.PixelFormat);
